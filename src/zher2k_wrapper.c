 ...
 ******************************************************************************/
parsec_taskpool_t*
dplasma_zher2k_New( dplasma_enum_t uplo,
                    ...
                    parsec_tiled_matrix_t* C)
{
    ...
    dplasma_add2arena_tile( &((parsec_zher2k_LN_taskpool_t*)tp)->arenas_datatypes[PARSEC_zher2k_LN_DEFAULT_ADT_IDX],
...
dplasma_zher2k_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &zher2k_tp->arenas_datatypes[PARSEC_zher2k_LN_DEFAULT_ADT_IDX] );
